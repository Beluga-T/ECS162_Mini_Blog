...
async function initializeDB() {
    ...
    const posts = [
        { title: 'Exploring the Mountains 🏔️', content: 'Just got back from a weekend trip to the mountains. The view was breathtaking and the fresh air was invigorating. Highly recommend! 🌲', username: 'user1', timestamp: '2024-01-01 12:30:00', likes: 7, game: 'General' },
        ...
        { title: 'Sunday Morning Run 🏃', content: 'Went for a run in the park this morning. The weather was perfect and the birds were singing. Feeling refreshed and ready to tackle the week! 🏞️', username: 'user2', timestamp: '2024-01-07 09:30:00', likes: 9, game: 'General' },
